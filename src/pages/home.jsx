  ...
  return (
    <div className="relative flex items-center justify-center overflow-hidden h-[80vh] sm:h-[90vh]">
      ...
      <video
        ...
        src="/img/home.mp4" // 👈 put your video file here (e.g. public/videos/home.mp4)
        autoPlay
        muted
        loop
        playsInline
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up delay-300">
          ...
          <Link to="/products">
            <Button
              variant="outlined"
              className="border-white text-white hover:bg-white/10 px-6 py-3 rounded-full text-lg transition-all duration-300 hover:scale-105"
            >
              View Products
            </Button>
          </Link>
