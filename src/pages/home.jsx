...
export function Home() {
  ...
  return (
    <>
      ...
      < section id="services" className="relative bg-gradient-to-b from-gray-50 to-white py-20 lg:py-28 px-4 bg-gradient-to-br from-blue-50 via-white to-indigo-50" >
        <div className="container mx-auto">
          {/* Header Section */}
          <div className="text-center mb-16">
          ...
          <div className="mb-20 py-16 bg-gradient-to-br  relative overflow-hidden">
      ...
      <div id="contact" className="contact-section">
        <div className="contact-container">
          ...
          <div className="contact-form">
            ...
            <h2 className="form-title mb-4 font-bold bg-gradient-to-r from-blue-800 to-orange-600 bg-clip-text text-transparent">Get Custom Packaging Solutions</h2>
